...
btn_1 = tk.Button(window,text="+",command=lambda: add_to_calculation("+"),width=5,font=("Arial",14))
...
btn_0 = tk.Button(window,text="(",command=lambda: add_to_calculation("("),width=5,font=("Arial",14))
...
btn_1 = tk.Button(window,text="C",command=clear_field,width=11,font=("Arial",14))
btn_1.grid(row=6,column=1,columnspan=2)
btn_1 = tk.Button(window,text="=",command=evaluate_calculation,width=11,font=("Arial",14,"bold"),bd=1,fg="#fff",bg="#3697f5")
btn_1.grid(row=6,column=3,columnspan=2)
window.mainloop()